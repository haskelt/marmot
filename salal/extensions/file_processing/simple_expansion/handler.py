...
class SimpleExpansion:
    ...
    def process (cls, source_file_path, target_file_path):
        ...
        output = template.render({'project': VariableTracker(config.site, success_callback = dependencies.variable_used, failure_callback = dependencies.variable_not_found)})
